...
class Feed extends Component {
  constructor(props) {
    super(props);
    this.runRandomizer = this.runRandomizer.bind(this)
  }

  runRandomizer(e) {
    this.props.randomizer()
    console.log("Hello from runRandomizer")
    console.log("props of randomFeed", this.props.randomFeed)
  }
  ...
  render() {
    ...
    return (
      <div className="col-md-10 col-md-offset-1">
        <button className="btn btn-danger" onClick={this.runRandomizer}>Click me!</button>
        <hr className="divider" />
...
class App extends Component {
  ...
  componentWillMount() {
    this.setAPIData()
    console.log("component mount randomFeed", this.state.randomFeed)
  }
  randomizer() {
  ...
  setAPIData() {
    ...
    let url = "https://newsapi.org/v1/articles?source=ign&sortBy=top&apiKey=b7382c933a4d4f5bb7bc07f575c97dc5"
  ...
  render() {
    return (
      <div className="App row">
        ...
        {/* Your code here*/}
        <Feed randomizer={this.randomizer} randomFeed={this.state.randomFeed} loader={this.state.loader}>
          <Loader />
        </Feed>
      </div>
    );
